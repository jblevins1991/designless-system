...
interface DialogProps
  extends Omit<AttributeType<HTMLDialogElement>, OmitDialogProps> {
...
const Dialog: React.FC<DialogProps> = ({
  ...
  return (
    <dialog
      className={classNames('dialog', open ? 'visible' : 'hidden', className)}
      role="dialog"
    >
      <div className="dialog-header">
        <Typography variant={headerTextVariant}>{title}</Typography>
